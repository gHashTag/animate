  ...
  render() {
    ...
    return (
      <View style={container}>
        ...
        <BoxAnimate tx={0} ty={scroll/delay200} source={require('./image/Stairs.png')}/>
        <BoxAnimate tx={0} ty={scroll/delay200} source={require('./image/Foundation.png')}/>
        <BoxAnimate tx={0} ty={scroll} source={require('./image/Logo.png')}/>
    </View>
    )
  }
}
